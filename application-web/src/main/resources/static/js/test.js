function testFun() {
	...
	AjaxFn.whenAllDone(deferreds, callbackFun);
...
function loadDataFun1(aVar) {
	...
	return AjaxFn.callPostFun(url, data, doneCallbackFun, ErrorFn.errorFun1).then(function (resp1) {
...
function loadDataFun2(aVar) {
	...
	return AjaxFn.callPostFun(url, null, doneCallbackFun, ErrorFn.errorFun1).then(function (resp2) {
