...
<head>
	...
	<title>${appTitle} | All Faculty Skillsets</title>
...
<body class="hold-transition sidebar-mini text-sm layout-fixed layout-navbar-fixed layout-footer-fixed">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Faculty Skillset Listing</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">List Faculty Skillsets</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">List Faculty Skillsets</h3>
							</div>
							<!-- /.card-header -->
							<div class="card-body">
								<table id="userSkillsetsTable" class="table table-bordered table-striped" aria-describedby="userSkillsetsTable">
									<thead>
										<tr>
	...
	<script>
		...
		var activationIsAllowed = ${appAuthorization.isAccessAllowed('userSkillset/activation')};
		var updateIsAllowed = ${appAuthorization.isAccessAllowed('userSkillset/update')};
	</script>
	<script src="${contextPath}static/js/common.js"></script>
	<script src="${contextPath}static/js/pages/userSkillset/list.js"></script>
</body>
</html>